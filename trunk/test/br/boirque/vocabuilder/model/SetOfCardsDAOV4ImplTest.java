...
public class SetOfCardsDAOV4ImplTest extends TestCase {
	...
	public void testAddCardV4() throws RecordStoreFullException, RecordStoreNotFoundException, RecordStoreException, IOException {
		...
		RecordStore recordStore = factory.getStoreInstance(setOfCards.getSetName());
	...
	public void testLoadSetMetadata() throws RecordStoreNotOpenException, InvalidRecordIDException, IOException, RecordStoreException  {
		...
		assertEquals("wrong card amount\n",TOTALOFCARDS , setOfCardsMeta.getTotalNumberOfCards());
...
//		fail("Not yet implemented");
	...
	public void testDeleteSetOfCards() {
		fail("Not yet implemented");
	}
	...
	public Test suite() {
			...
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testLoadFileFormatVersionNumber", new TestMethod(){ 
				public void run(TestCase tc) throws RecordStoreNotOpenException, RecordStoreFullException, IOException, RecordStoreException {
					((SetOfCardsDAOV4ImplTest) tc).testLoadFileFormatVersionNumber(); 
				} 
			}));		
			
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testLoadSetMetadata", new TestMethod(){ 
				public void run(TestCase tc) throws RecordStoreNotOpenException, RecordStoreFullException, IOException, RecordStoreException {
			...
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testUpdateCard", new TestMethod(){ 
			...
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testGetCardCount", new TestMethod(){ 
				public void run(TestCase tc) throws RecordStoreNotOpenException, RecordStoreFullException, IOException, RecordStoreException {
					((SetOfCardsDAOV4ImplTest) tc).testGetCardCount(); 
				} 
			}));
			
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testAddSetMetadata", new TestMethod(){ 
				public void run(TestCase tc) throws RecordStoreNotOpenException, InvalidRecordIDException, IOException, RecordStoreException{
					((SetOfCardsDAOV4ImplTest) tc).testAddSetMetadata(); 
				} 
			}));
			
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testUpdateSetMetadata", new TestMethod(){ 
				public void run(TestCase tc) throws RecordStoreNotOpenException, InvalidRecordIDException, IOException, RecordStoreException{
					((SetOfCardsDAOV4ImplTest) tc).testUpdateSetMetadata(); 
				} 
			}));
			
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testResetState", new TestMethod(){ 
				public void run(TestCase tc) throws RecordStoreNotOpenException, RecordStoreFullException, IOException, RecordStoreException {
			...
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testLoadSetOfCards", new TestMethod(){ 
				public void run(TestCase tc) throws RecordStoreNotOpenException, RecordStoreFullException, IOException, RecordStoreException {
					((SetOfCardsDAOV4ImplTest) tc).testLoadSetOfCards(); 
				} 
			}));
			
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testLoadCard", new TestMethod(){ 
				public void run(TestCase tc) throws RecordStoreNotOpenException, RecordStoreFullException, IOException, RecordStoreException {
					((SetOfCardsDAOV4ImplTest) tc).testLoadCard(); 
				} 
			}));
			
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testAddFileFormatVersionNumber", new TestMethod(){ 
				public void run(TestCase tc) throws RecordStoreNotOpenException, RecordStoreFullException, IOException, RecordStoreException {
					((SetOfCardsDAOV4ImplTest) tc).testAddFileFormatVersionNumber(); 
				} 
			}));
			
	
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testSaveSetOfCardsV4", new TestMethod(){ 
				public void run(TestCase tc) throws RecordStoreNotOpenException, RecordStoreFullException, IOException, RecordStoreException {
					((SetOfCardsDAOV4ImplTest) tc).testSaveSetOfCardsV4(); 
				} 
			}));
			
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testAddCardV4", new TestMethod(){ 
				public void run(TestCase tc) throws RecordStoreNotOpenException, RecordStoreFullException, IOException, RecordStoreException {
			...
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testCardToByteArray", new TestMethod(){ 
				public void run(TestCase tc) {
					((SetOfCardsDAOV4ImplTest) tc).testCardToByteArray(); 
				} 
			}));
			
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testGetAvailableSets", new TestMethod(){ 
				public void run(TestCase tc)  {
			...
			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testGetRecordCount", new TestMethod(){ 
				public void run(TestCase tc) {
					((SetOfCardsDAOV4ImplTest) tc).testGetRecordCount(); 
				} 
			}));

			testsuite.addTest(new SetOfCardsDAOV4ImplTest("testDeleteSetOfCards", new TestMethod(){ 
				public void run(TestCase tc)  {
